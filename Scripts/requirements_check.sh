...
supported_ubuntu=("12.04" "14.04" "16.04" "18.04" "20.04")
...
connectivity_check1=false
connectivity_check2=false
connectivity_check3=false
connectivity_check4=false
connectivity_check5=false
connectivity_check6=false
connectivity_check7=false
connectivity_check8=false
connectivity_check9=false
connectivity_check10=false
...
analytics=$(curl -s https://analytics.blazemeter.com/data/api/v1 -I | grep "HTTP" | awk '{print $2}') # 401
googleapis=$(curl -s https://storage.googleapis.com | grep Authorization | cut -d '>' -f 8 | cut -d '<' -f 1) # Authorization

# Verifies connectivity to https://a.blazemeter.com
if [[ $performance == 401 ]]
then
  echo -e "\e[32mConnection to https://a.blazemeter.com successful."
  connectivity_check1=true
else
...
then
  ...
  connectivity_check8=true
else
  echo -e "\e[31mConnection to https://gcr.io/verdant-bulwark-278 unsuccessful."
fi

# Verifies connectivity to https://analytics.blazemeter.com
if [[ $analytics == 401 ]]
then
  echo -e "\e[32mConnection to https://analytics.blazemeter.com successful."
  connectivity_check9=true
else
  echo -e "\e[31mConnection to https://analytics.blazemeter.com unsuccessful."
fi

# Verifies connectivity to https://storage.googleapis.com
if [[ $googleapis == "Authorization" ]]
then
  echo -e "\e[32mConnection to https://storage.googleapis.com successful."
  connectivity_check10=true
else
  echo -e "\e[31mConnection to https://storage.googleapis.com unsuccessful."
fi

if [ $connectivity_check1 == true ] && [ $connectivity_check2 == true ] && [ $connectivity_check3 == true ] && [ $connectivity_check4 == true ] && [ $connectivity_check5 == true ] && [ $connectivity_check6 == true ] && [ $connectivity_check7 == true ] && [ $connectivity_check8 == true ] && [ $connectivity_check9 == true ] && [ $connectivity_check10 == true ]
then
